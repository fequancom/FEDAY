...
https://feuqna.com/2025/[](https://feuqna.com/2025/)

1、如何基于 Claude Code 打造一款适合企业内部的类似于 Lovable / v0dev 的 AI Coding Agent？
分享嘉宾：宝玉

2、AI在营销活动页面制作上的实践与思考
分享嘉宾：仝守玉

3、通过自学习用户行为，让语音应用越用越聪明
分享嘉宾：赵恩（Lois）

4、以父之名的创业：AI 时代为孩子打造全新的学习理念
分享嘉宾：张云龙

5、AI 能怎么助力个人开发者贡献前端开源基建？
分享嘉宾：沈青川

6、从next-auth到better-auth：如何用几行代码解决用户登录
分享嘉宾：面包

7、告别 Loading：用同步引擎重构即时体验
分享嘉宾：胡文召

8、阿里云RDS Supabase + AI Coding：构建前端驱动的生成式AI应用平台
分享嘉宾：日近

9、超越界面：前端工程师如何塑造 AI 原生应用的未来
分享嘉宾：吴天炜

10、AI Coding，重燃这群工程师年轻的心！
分享嘉宾：山果

11、AI 编程的"认知税"
分享嘉宾：俞天翔

12、Chrome Built-in AI：装在浏览器里的智能引擎
分享嘉宾：钱俊颖
